...
public class MySnitchFragment extends Fragment{
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {

		View fragmentView = inflater.inflate(R.layout.fragment_mysnicthes,
				container,false);
		// Actionbar Settings
		// Actionbar Settings
		...
		actionBarTitle.setText("Yakaladıklarım");
	...
	public static Fragment newInstance() {
		MySnitchFragment mFrgment = new MySnitchFragment();
		return mFrgment;
	}
